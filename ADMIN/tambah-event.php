...
<body class="bg-gray-100 p-6">
  ...
  <div class="max-w-xl mx-auto bg-white rounded-lg shadow-md p-6">
    ...
    <form action="proses-tambah-event.php" method="POST" enctype="multipart/form-data" class="space-y-4">
      <div>
        <label for="judul" class="block text-gray-700 font-medium mb-1">Judul Event</label>
      ...
      <div>
        <label for="foto" class="block text-gray-700 font-medium mb-1">Foto Event</label>
