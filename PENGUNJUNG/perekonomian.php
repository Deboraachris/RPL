...
<body>
    ...
    <section class="section">
        <h2>PEREKONOMIAN</h2>
        <p style="text-align: center;">Kondisi Perekonomian Masyarakat Desa Sepakung</p>
        <div class="image-stack">
            <img src="../FOTO/g30.png" alt="penduduk" style="max-width: 40%; height: auto;">
            <img src="../FOTO/g31.png" alt="penduduk" style="max-width: 40%; height: auto;">
            <img src="../FOTO/g32.png" alt="penduduk" style="max-width: 40%; height: auto;">
            <img src="../FOTO/g33.png" alt="penduduk" style="max-width: 40%; height: auto;">
        </div>
