...
<body>
    ...
    <section class="section">
        ...
        <div style="text-align: center; margin-top: 20px;">
            <img src="../FOTO/g22.png" alt="Geografi" style="max-width: 100%; height: auto;">
        </div>

        <h3>Luas wilayah Desa Sepakung seluas  786,670 Ha, yang terdiri dari :</h3>
    <ul>
    ...
    <div style="text-align: center; margin-top: 20px;">
            <img src="../FOTO/g23.png" alt="Geografi" style="max-width: 100%; height: auto;">
        </div>
