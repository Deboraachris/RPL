...
<body>
    ...
    <section class="section">
        <h2>SARPRAS</h2>
        <p style="text-align: center;">Sarana dan Prasarana Desa Sepakung</p>
        <div class="image-stack">
            <img src="../FOTO/g37.png" alt="penduduk" style="max-width: 40%; height: auto;">
            <img src="../FOTO/g38.png" alt="penduduk" style="max-width: 40%; height: auto;">
